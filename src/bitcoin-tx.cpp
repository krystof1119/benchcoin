...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " benchcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  benchcoin-tx [options] <hex-tx> [commands]  Update hex-encoded benchcoin transaction\n" +
            "or:     benchcoin-tx [options] -create [commands]   Create hex-encoded benchcoin transaction\n" +
            "\n";
