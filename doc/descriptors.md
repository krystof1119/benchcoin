# Support for Output Descriptors in Benchcoin Core

Since Benchcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `bench1...` for mainnet or `tbench1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Benchcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Benchcoin Core wallets, a convenience function `combo` is
