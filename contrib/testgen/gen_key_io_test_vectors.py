...
bech32_templates = [
  ...
  ('bench',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('bench',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('bench',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tbench',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tbench',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tbench',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rbench',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rbench',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rbench', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tbench',  17, 32, False, False, False),
  ('rbench',  3,  1, False, False, False),
  ('bench',   15, 41, False, False, False),
  ('tbench',  0, 16, False, False, False),
  ('rbench',  0, 32, True,  False, False),
  ('bench',   0, 16, True,  False, False),
  ('tbench',  0, 32, False, True,  False),
  ('rbench',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['bench', 'tbench', 'rbench']:
