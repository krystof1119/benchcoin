...
"""Verify that starting benchcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start benchcoin with -h for help text")
        ...
        self.log.info("Start benchcoin with -version for version information")
        ...
        self.log.info("Start benchcoind with -fakearg to make sure it does not start")
